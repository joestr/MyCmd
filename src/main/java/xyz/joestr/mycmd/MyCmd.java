...
public class MyCmd extends JavaPlugin {
 ...
 /* TODO
     ...
     * @version 1
     * @since 1
     * @param alternativeColorcode {@link String} Alternativer String welcher
     * einen Farb-Code bezeichnet.
    ...
    /**
     * Sendet einem Befehlssender eine Nachricht zur richtigen Benutzung eines
     * Befehls
     *
     * @author joestr
     * @version 1
    ...
    /**
     * Sendet einem Spieler eine Nachricht zur richtigen Benutzung eines
     * Befehls.
     *
     * @author joestr
     * @version 1
    ...
    public void sendPlayerlistHeaderFooter(Player player, String header, String footer) {
        ...
        Object packet = null;
        try {
            packet = Reflection.getNMSClass("PacketPlayOutPlayerListHeaderFooter").newInstance();
        } catch (Exception exception) {
            exception.printStackTrace();
        }
    ...
    public void commandOverview(Player player, String title, String[] texts, String[] actions, String[] commands, String[] hovers) {
        ...
        if (texts.length != commands.length || texts.length != actions.length || texts.length != hovers.length) {
            player.sendMessage(ChatColor.RED + "Hier ist ein Fehler. Bitte einem Admin melden. Code: FQ-1");
        }
    ...
    public void removeFallbackAliases() {
        ...
        try {
            ...
            for (String key : knownCommandsClone.keySet()) {
