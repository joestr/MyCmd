...
public class RemoteConsoleCommandBan_ip {
	...
	public void process(RemoteConsoleCommandSender remoteConsoleCommandSender, String[] args) {
		...
		if(!args[0].matches(p.toString())) {
			...
			remoteConsoleCommandSender.sendMessage(ChatColor.RED + "Es muss eine gültige IP-Adresse angegeben werden.");
			return;
		}
