...
public class ProxiedCommandBan_ip {
	...
	public void process(ProxiedCommandSender proxiedCommandSender, String[] args) {
		...
		if(!args[0].matches(p.toString())) {
			...
			proxiedCommandSender.sendMessage(ChatColor.RED + "Es muss eine gültige IP-Adresse angegeben werden.");
			return;
		}
